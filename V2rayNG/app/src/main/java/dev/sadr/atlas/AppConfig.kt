...
object AppConfig {
    ...
    const val PREF_PROXY_ENGINE = "pref_proxy_engine"
    ...
    const val PREF_AUTO_BEST_DEFAULT_MIGRATED = "pref_auto_best_default_migrated"
    ...
    const val APP_RELEASE_API_URL = "https://api.github.com/repos/2dust/v2rayNG/releases/latest"
    ...
    const val MSG_TRAFFIC_UPDATE = 13
    ...
    const val RAY_NG_CHANNEL_NAME = "AtlasVPN Background Service"
